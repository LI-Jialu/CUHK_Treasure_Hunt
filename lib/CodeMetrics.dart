/*
Module to produce code metrics such as McCabe's number.
...
void main() {
  ...
  const filesToAnalyze = ['Item.dart','PostItem.dart','User.dart','UserVerification.dart'];

  // Root folder path is used to resolve relative file paths
  const rootFolder = 'lib/classes';
  ...
  const reporterConfig = Config(
      cyclomaticComplexityWarningLevel: 0,
